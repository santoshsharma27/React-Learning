function MemeCard({ meme }) {
  ...
  return (
    <div className="m-5 w-80 transform overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg transition-shadow duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 hover:shadow-2xl">
